export default function Home() {
    return (
        <section id='home' className='min-h-screen relative bg-[url("/hero-bg.webp")] bg-no-repeat selection:text-background selection:bg-primary bg-cover bg-center w-screen h-screen'>
